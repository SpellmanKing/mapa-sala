  ...
  try {
    ...
    ws.onmessage = async (event) => {
          ...
          params: {
            expression: `
              (async () => {
                ...
                if (optSala1) {
                  roomSelect.value = optSala1.value;
                ...
                if (turnoSelect) {
                  ...
                  if (optNoite) {
                    turnoSelect.value = optNoite.value;
      ...
      if (msg.id === 30) {
        ...
        const success = result && result.found && result.text.includes('Conflito');
        console.log(success ? "SUCCESS: Custom conflict error toast was displayed successfully!" : "FAILURE: Toast not found or incorrect message!");
